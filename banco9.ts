...
/* ci1: ContaImposto = new ContaImposto('3333-3', 1000, 0.38);
ci1.sacar(100);
...
banco.inserirConta("1234-5", 'contaCorrente', 1000, undefined, 500, 10)

//Associar a conta ao cliente
banco.atribuirTitularidade('1234-5', cliente.cpf)

//Criar uma poupanca
banco.inserirConta("1234-6", 'poupanca', 1000, 2 )

//Render Juros
banco.renderJuros("1234-6")


//Sacar usando o limite especial da conta corrente
const contaCorrente = banco.consultar("1234-5") as ContaCorrente
contaCorrente.sacar(1400)
