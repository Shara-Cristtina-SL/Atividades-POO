import { ContaInexistenteError } from "./classe_error";
...
export class Banco {
    ...
    public consultar(numero: string): Conta | Poupanca | ContaImposto | ContaCorrente {
    ...
    public consultarPorCpf(cpf: string): Cliente {
        try {
            ...
            throw new ContaInexistenteError(`Cliente com CPF ${cpf} não encontrado.`);
        } catch (erro) {
